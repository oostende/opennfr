...
def InitUsageConfig():
	...
	if getBoxType() in ('gbquadplus', 'gb800ueplus', 'gbultraue', 'gb800seplus', 'gbultraue', 'gb7362', 'twinboxlcd', '7210s', 'vusolo4k', 'odin2hybrid', 'odinplus', 'e4hd', 'singleboxlcd', 'sf208', 'sf228'):
